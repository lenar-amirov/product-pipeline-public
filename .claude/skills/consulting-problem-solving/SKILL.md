...
description: "Interactive consulting-style problem solving: MECE issue trees, hypothesis-driven analysis, pyramid principle, 80/20 prioritization — user leads as partner, Claude executes as associate, deliverables at every stage. Use for: 'structured approach to X', 'issue tree', 'MECE', 'root cause analysis', 'how would a consultant approach this', 'help me think through this problem', 'business case analysis'."
---
